...
def demo(pix, anime, node):           
    ...
    opacity.setKeyValueAt(.50, .80)
    opacity.setKeyValueAt(.55, .0)
    opacity.setKeyValueAt(.70, .0)
    opacity.setKeyValueAt(.75, .50)
    opacity.setKeyValueAt(.80, .75)
    ...
    scale.setKeyValueAt(.45, pix.scale*.85)
    scale.setKeyValueAt(.47, pix.scale*.50)
    scale.setKeyValueAt(.55, pix.scale*.0)
    scale.setKeyValueAt(.70, pix.scale*.0)
