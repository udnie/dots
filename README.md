...
Currently **dots** is running on **PyQt 6.6.1**, **Python 3.11.9** and **Sonoma 14.5** on a M1 MacBook in **X86 mode.** As of **June 2024** you can now run **dots** on **Apple Silicon** using **PyQt5**. Definitely read the **June 2024** entry in **Changes.md** - it's not difficult.
