...
___
**May 26**        
I've moved the Screen Formats Menu to dotsScreens.py and the Demos Menu to dotsSnakes.py. I've also added the appropiate messages to fill-in what I left out earlier.
